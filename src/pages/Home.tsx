...
import {
  ...
  Clock, Headphones, Layers, Gauge, Users, MapPin,
} from 'lucide-react';
      ...
      <section className="bg-canvas-soft border-t border-hairline">
        <div className="mx-auto max-w-[1400px] px-6 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-canvas rounded-md border border-hairline overflow-hidden shadow-[0_0_30px_rgba(6,182,212,0.06)]">
