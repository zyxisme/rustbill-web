  ...
  ({ className, variant = "default", onClose, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "relative w-80 rounded-lg border border-hairline bg-canvas-soft p-4 shadow-[0_0_40px_rgba(0,209,167,0.06)] hover:shadow-[0_0_40px_rgba(0,209,167,0.12)] transition-shadow",
